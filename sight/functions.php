...
function wpsplash_saveExtraProfileFields($userID) {
	...
	update_usermeta($userID, 'website', $_POST['website']);
	update_usermeta($userID, 'blog', $_POST['blog']);
	update_usermeta($userID, 'tumblr', $_POST['tumblr']);
	...
	update_usermeta($userID, 'reddit', $_POST['reddit']);
	update_usermeta($userID, 'flickr', $_POST['flickr']);
	update_usermeta($userID, 'urole', $_POST['urole']);
}
	...
	<table class='form-table'>
		<tr>
			...
			<td>
				...
				<br />
				<span class='description'>Please enter your Website URL. 
			</td>
		</tr>
		<tr>
			<th><label for='blog'>Blog</label></th>
			<td>
				<input type='text' name='blog' id='blog' value='<?php echo esc_attr(get_the_author_meta('blog', $user->ID)); ?>' class='regular-text' />
				<br />
				<span class='description'>Please enter your Blog URL. 
			</td>
		</tr>
		<tr>
			<th><label for='tumblr'>Tumblr</label></th>
			<td>
				<input type='text' name='tumblr' id='tumblr' value='<?php echo esc_attr(get_the_author_meta('tumblr', $user->ID)); ?>' class='regular-text' />
				<br />
				<span class='description'>Please enter your Tumblr name. http://<strong>username</strong>tumblr.com.</span> 
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type='text' name='reddit' id='reddit' value='<?php echo esc_attr(get_the_author_meta('reddit', $user->ID)); ?>' class='regular-text' />
				<br />
				<span class='description'>Please enter your Reddit username. http://reddit.com/user/<strong>username</strong></span>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type='text' name='urole' id='urole' value='<?php echo esc_attr(get_the_author_meta('urole', $user->ID)); ?>' class='regular-text' />
				<br />
				<span class='description'>Site Role goes here. DO NOT CHANGE. </span>
			</td>
		</tr>
	</table>
<?php } ?>
