    ...
    if ( !empty($slides) ) : $exl_posts = Array(); ?>
        ...
        <div class="slide clear">
            <div class="post">
                ...
                <div class="post-content"><?php if ( has_post_thumbnail() && function_exists('smart_excerpt') ) smart_excerpt(get_the_excerpt(), 35); else smart_excerpt(get_the_excerpt(), 10); ?></div>
            </div>
        </div>
        <?php endforeach; ?>
